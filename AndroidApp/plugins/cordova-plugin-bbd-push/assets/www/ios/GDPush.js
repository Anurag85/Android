...
(function() {
     ...
     *
     * @example
     * // This object is used by GDPushConnection.parseChannelResponse() method and is not used directly
     */
    ...
    GDPushConnection.prototype.initialize = function(onConnected, onDisconnected) {
        if (typeof onConnected !== 'function') {
            throw new Error("ERROR in GDPushConnection.initialize: onConnected parameter is not a function.");
        }

        if (typeof onDisconnected !== 'function') {
            throw new Error("ERROR in GDPushConnection.initialize: onDisconnected parameter is not a function.");
        }
