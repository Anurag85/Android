...
(function() {
     ...
     *  } catch(e) {
     *       throw new Error("Unable to parse configuration JSON format: " + result);
     * }
     * };
     *
    ...
    GDApplication.prototype.getApplicationConfig = function(onSuccess, onError) {
        if (typeof onSuccess !== 'function') {
            throw new Error("ERROR in GDApplication.getApplicationConfig: onSuccess parameter is not a function.");
        }
