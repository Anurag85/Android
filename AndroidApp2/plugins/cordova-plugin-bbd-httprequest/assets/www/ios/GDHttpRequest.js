...
(function() {
        ...
        try {
            ...
            try {
                if (typeof escapedJson.responseText === 'Object') {
                    responseText = JSON.stringify(escapedJson.responseText);
                } else {
                    responseText = escapedJson.responseText;
                }
            } catch (e) {
                responseText = escapedJson.responseText;
            }
     ...
     */
    GDHttpRequest.prototype.createRequest = function(method, url, timeout, isAsync,
        user, password, auth, authDomain, isIncremental) {
     ...
     *  } catch(e) {
     *      throw new Error("Invalid response object returned from call to send.");
     *  }
     *  };
     *
     * function sendFail() {
    ...
    GDHttpRequest.prototype.sendFile = function(fileName, success, fail) {
        if (typeof fileName === 'Object' || typeof fileName === 'undefined') {
            throw new Error("ERROR: invalid fileName passed to sendFile.");
        } else
