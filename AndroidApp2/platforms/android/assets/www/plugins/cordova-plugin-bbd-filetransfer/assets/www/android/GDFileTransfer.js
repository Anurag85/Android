cordova.define("cordova-plugin-bbd-filetransfer.FileTransfer", function(require, exports, module) {
/**
...
(function() {
     ...
     * @classdesc FileTransfer downloads/uploads a file from/to a remote server.
     */
     ...
     * });
     */
    GDFileTransfer.prototype.upload = function(filePath, server, successCallback, errorCallback,
    ...
    for (protoFunction in GDFileTransfer.prototype) {
        if (GDFileTransfer.prototype.hasOwnProperty(protoFunction)) {
            ...
            var objProtoProperty = GDFileTransfer.prototype[protoFunction],
