cordova.define("cordova-plugin-bbd-storage.FileWriter", function(require, exports, module) {
/*
...
(function() {
    ...
    GDFileWriter.prototype.write = function(data) {
        ...
        var that = this,
            supportsBinary = (typeof window.Blob !== 'undefined' && typeof window.ArrayBuffer !== 'undefined'),
            isBinary;
    ...
    for (protoFunction in GDFileWriter.prototype) {
        if (GDFileWriter.prototype.hasOwnProperty(protoFunction)) {
            ...
            var objProtoProperty = GDFileWriter.prototype[protoFunction],
